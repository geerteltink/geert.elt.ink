...
For a long time, I've been wondering how to make code completion work in PhpStorm for dependency containers. These containers used the `Interop\Container\ContainerInterface` and since February 2017 it's accepted by PHP-Fig as PSR-11
...
I guess the past half year I didn't ask the right question to google because this morning it suddenly showed up. It turns out be really easy. All you need is a `.phpstorm.meta.php` file in your project root, configure it a bit and the magic is there again.
