...
Yesterday I wrote about using [one ActionFactory for all](https://www.elt.ink/blog/2015-12-29-zend-expressive-action-factory-one-for-all) your PSR-7 actions. I used zend-servicemanager for it, together with some voodoo to detect the dependencies and inject it. I was pretty happy with the solution and then I got this:
...
At the time of writing, this solution is used for this site, and it's [open source](https://github.com/geerteltink/www.elt.ink/).
