...
- Server: `Docker` _(It's the server configured in the previous step)_
- Configuration file(s): `./docker-compose.yml`
- Service: `php` _(it's the php service name from docker-compose.yml)_
- Environment variables: _(leave empty, but click the 3 dots on the right and deselect `Include parent environment variables`)_
...
- Default configuration file: `/app/phpunit.xml.dist` _(Enable via the checkbox and add the path)_
