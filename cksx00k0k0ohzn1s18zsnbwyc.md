...
I always skipped static site generators because I couldn't use it to queue blog posts. That's where GitHub Actions come in. It has support for cron jobs. So basically you can trigger new builds each morning. When you set a blog post to a future date, it won't be visible until that day the cron job was triggered.
