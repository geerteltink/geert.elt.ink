...
I started with [GitHub pages](https://help.github.com/en/github/working-with-github-pages/creating-a-github-pages-site). The main organization site was simple. Generate some html and push it to a master branch in `<organization>.github.io`. Done. Next up was adding project sites. Project sites are build automatically from the docs folder if you use Jekyll or you push the html pages directly to a `gh-pages` branch. That was easily done and I got the documentation online.
